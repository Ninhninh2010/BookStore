		...
		<div class="row">
			...
			<div class="span9">
				<ul class="breadcrumb">
					...
					<li class="active">EmailVerify</li>
				</ul>
				<h3>Registration</h3>
				<hr class="soft" />
				...
				<div class="well">
					<form action="email" class="form-horizontal" method="post">
						<a>${mess1}</a>

						<div class="control-group">
							<label class="control-label" for="inputFname">Nhập email tài khoản <sup>*</sup>
							</label>
							<div class="controls">
								<input type="text" id="inputFname" placeholder="Email"
									name="email">
							</div>
						</div>
